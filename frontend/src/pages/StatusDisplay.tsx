    ...
    useEffect(() => {
        ...
        ws.onmessage = (event) => {
            ...
            if (msg.event === 'queue_member_called' && msg.called) {
                ...
                setStatus(prev => prev ? { ...prev, queue_size: msg.queue_size } : prev);
            ...
            <div style={{ width: '100%', maxWidth: 1200, padding: '40px 60px' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <span style={{ color: 'var(--accent-success)', fontSize: '0.9rem', fontWeight: 600 }}>
                            AO VIVO
                        </span>
                    </div>
                </div>
                        ...
                        <div style={{
                            ...
                            <p
                                ...
                                style={{
                                    ...
                                    color: status.queue_size === 0 ? 'var(--accent-success)' : 'var(--text-primary)'
                                }}
                            >
                                {status.queue_size}
                            </p>
